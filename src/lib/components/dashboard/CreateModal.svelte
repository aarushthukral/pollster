    ...
    <div class="min-h-screen px-4 text-center">
      ...
      <TransitionChild
        ...
        <form
          ...
          action="/dashboard"
          use:enhance
          class="my-8 inline-block w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white p-6 text-left shadow-xl transition-all dark:bg-black sm:align-middle">
